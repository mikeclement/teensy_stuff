...
#  If needed, define the Teensy 3.x library directories for the
#  link operation.  These directories will hold your own library
#  modules, not those distributed by GCC or your compiler suite.
TEENSY3X_LIBDIRS = $(TEENSY3X_BASEPATH)/library
...
LIBDIRS  = -L$(TOOLPATH)/lib/gcc/arm-none-eabi/4.5.2
LIBDIRS += -L$(TEENSY3X_LIBDIRS)
LIBS  = -luart  -ltermio
LIBS += -lgcc
